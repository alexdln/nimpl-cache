...
export class CacheHandler implements CacheHandlerRoot {
    ...
    constructor({ ephemeralLayer, persistentLayer, logger }: CacheHandlerOptions) {
        ...
        this.ephemeralLayer = ephemeralLayer;
    ...
    async delete(key: string) {
        await Promise.all([this.ephemeralLayer.delete(key), this.persistentLayer.delete(key)]);
    }
